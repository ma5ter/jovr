...
DESCRIPTION="JetBrains CLion IDE"
HOMEPAGE="https://www.jetbrains.com/clion/"
SRC_URI="https://download-cdn.jetbrains.com/cpp/CLion-${SLOT}.tar.gz"
...
# Note, named same as ebuild!
#S="${WORKDIR}/clion-${SLOT}"
...
pkg_postinst() {
    ...
    eselect jetbrains set clion "$SLOT"
